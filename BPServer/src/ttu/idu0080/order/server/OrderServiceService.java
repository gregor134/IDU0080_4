...
public class OrderServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projektid/IDU0080_4/BPServer/WebContent/orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projektid/IDU0080_4/BPServer/WebContent/orders.wsdl");
        }
        WSDL_LOCATION = url;
    }

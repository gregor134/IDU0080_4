...
public class Bp_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projektid/IDU0080_4/BP/WebContent/bp.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Bp_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projektid/IDU0080_4/BP/WebContent/bp.wsdl");
        }
        WSDL_LOCATION = url;
    }

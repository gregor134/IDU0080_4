...
public class Transport_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projektid/IDU0080_4/BPTeenused/WebContent/transport.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Transport_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projektid/IDU0080_4/BPTeenused/WebContent/transport.wsdl");
        }
        WSDL_LOCATION = url;
    }
